...
# def get_single_sample_feature(img_seq, joint_time_seq, z, theta):
...
# def get_samples_feature(joint_id, imgs, joints, theta, num_feats=NUM_FEATS):
...
#         feature[:, sample_id, :] = get_single_sample_feature(  # 一次采样的特征(T*500)
...
#         f = get_single_sample_feature(img_seq, qm[:, i], body_center_z, theta)
...
if __name__ == "__main__":
    ...
    if args.load_model:
        ...
        # for joint_id in range(NUM_JOINTS):
        #     feature, unit = get_samples_feature(
